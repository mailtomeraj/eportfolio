...
const HomeComponent = () => {
  ...
  return (
    ...
    //     className=" min-h-[500px]  max-[1200px] 
    //     bg-[linear-gradient(62deg,_#fff_0_50%,_#48AFDE_0_100%)]  h-full w-full
    //    "
      >
            ...
            <div className=" bg-white  flex flex-col justify-center col-span-12 md:col-span-5  md:bg-transparent">
              <div className="container m-auto">
                <div className="lg:pl-24 sm:pl-10 pl-0 md:py-0 py-20 md:text-start text-center">
                  ...
                  >
                    Full-Stack (Next.js 14) Developer <br/>Front-end UI Developer
                  </h2>
                  ...
                  <a
                    href="Meraj_Naqui.pdf"
                    download="Meraj Naqui.pdf"
