        ...
        >
          <div className="grid grid-cols-12">
            <div className="col-span-12 lg:col-span-9">
              ...
              I'm currently avaliable to take on new projects, so feel free to send me a message about anything that you want to run past me. I'm also avaliable for hire as well.
          ...
          <div className="grid gap-6 grid-cols-5 md:pt-20">
            <div className="md:block hidden">
              ...
              <p className="text-xs text-[#7b858b] font-sans ">
                &copy; 2024. Built by Meraj Naqui
              </p>
            </div>
            ...
            <div className="flex  flex-wrap justify-between items-center">
              ...
              <div className="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                <a
                  className="group flex flex-col items-center justify-center"
                  target="_blank"
                  href="https://www.linkedin.com/in/merajnaqui/"
                >
                  {" "}
                  <svg
                    stroke="currentColor"
              ...
              <div className="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                <a
                  className="group flex flex-col items-center justify-center"
                  target="_blank"
                  href="https://www.instagram.com/merajnaqui"
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
