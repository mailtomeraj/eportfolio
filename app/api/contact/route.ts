...
export async function POST(request:any) {
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        ...
        user: 'mailtomeraj@gmail.com',
        pass: 'dxlupswvljvygkco',
      },
    })
...
<body>
    ...
    if(info.messageId){
      return NextResponse.json({ error:false, message:"Message successfully sent! Thank you for contacting Meraj Naqui" })
